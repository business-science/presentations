...
```{r, echo=F, fig.align="center", fig.cap="Grid Search Optimization For Trading Algorithm"}
knitr::include_graphics("img/portfolio_value_grid.png")
```


```{r, echo=F, fig.align="center", fig.cap="Portfolio Value Over Time"}
knitr::include_graphics("img/portfolio_over_time.png")
```